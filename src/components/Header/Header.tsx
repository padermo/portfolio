...
export default function Header(){
  ...
  return(
    <main className='w-full min-h-dvh max-h-full relative flex flex-col md:flex-row lg:flex-row gap-6 lg:gap-10 items-center justify-center bg-gray-100 px-4 md:px-8 lg:px-10 dark:bg-[#222]'>
      <CldImage src={'https://res.cloudinary.com/dultasdzm/image/upload/v1709752022/portfolio/perfil_iaqvcd.png'} alt='Fabio Estevez' loading='lazy' width={500} height={500} className='w-40 h-40 drop-shadow-xl md:w-56 md:h-56 lg:w-56 lg:h-56 object-cover rounded-full'/>
