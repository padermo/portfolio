...
export default function Projects(){
  ...
  return(
    <section id='projects' ref={projectsRef} className='h-[300dvh] relative bg-gray-100 dark:bg-[#222]'>
      <div className='sticky top-0 h-dvh w-full flex flex-col items-center justify-center gap-10 overflow-hidden'>
        <h2 ref={titleRef} style={{opacity: isInView ? 1:0, transition: 'opacity 0.5s ease-in-out'}} className='text-2xl text-[#CFB53B] tracking-widest font-semibold'>{t('title')}</h2>
